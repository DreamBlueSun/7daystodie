...
public class GunLeverActionRifle {
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunRifleT2LeverActionRifle";

    // 狂化Tag
    public static final String T1_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,mediumTopAttachments,largeTopAttachments,stock,bottomAttachments,attPerception,perkDeadEye,attachmentsIncluded,canHaveCosmetic,rifleSkill,rangerDamage,marisaLeverActionRifle\"/>";
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,mediumTopAttachments,largeTopAttachments,stock,bottomAttachments,attPerception,perkDeadEye,attachmentsIncluded,canHaveCosmetic,rifleSkill,rangerDamage,marisaLeverActionRifle,PerkT3Marisa\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunLeverActionRifleSMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <property name=\"Sound_loop\" value=\"lever_action_rifle_fire\"/>\n" +
            "                <property name=\"Sound_repeat\" value=\"\"/>\n" +
            "                <property name=\"Sound_end\" value=\"\"/>\n" +
            "                <property name=\"Sound_empty\" value=\"dryfire\"/>\n" +
            "                <property name=\"Sound_reload\" value=\"\"/>\n" +
            "                <property name=\"AutoReload\" value=\"false\"/>\n" +
            "                <property name=\"Particles_muzzle_fire\" value=\"gunfire_rifle_lever\"/>\n" +
