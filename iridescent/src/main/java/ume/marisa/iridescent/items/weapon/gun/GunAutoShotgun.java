...
public class GunAutoShotgun {
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunShotgunT3AutoShotgun";
    ...
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,shotgun,shortRange,barrelAttachments,sideAttachments,smallTopAttachments,noScopes,stock,magazine,drumMagazine,firingMode,bottomAttachments,attStrength,perkBoomstick,attachmentsIncluded,canHaveCosmetic,shotgunSkill,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"200,300\" tier=\"1,6\" tags=\"perkBoomstick\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,220,240,260,280,300\" tier=\"1,2,3,4,5,6\" tags=\"perkBoomstick\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunAutoShotgunSMarisaWeaponFlag_RANK\">\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunAutoShotgunSMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <passive_effect name=\"MagazineSize\" operation=\"base_set\" value=\"13.5\" tags=\"perkBoomstick\"/>\n" +
