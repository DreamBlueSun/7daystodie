...
public class GunHuntingRifle {
    ...
    // 伤害
    public static final int RANK_ENTITY_DAMAGE_S0 = 120;
    public static final int[] RANK_ENTITY_DAMAGE_ARR = new int[]{30, 30, 30, 30, 40, 40, 40, 40, 50, 50, 50, 50, 0};
    public static final String RANK_ENTITY_DAMAGE_TIER = "0,30";
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunRifleT1HuntingRifle";

    // 狂化Tag
    public static final String T1_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,mediumTopAttachments,largeTopAttachments,stock,bottomAttachments,attPerception,perkDeadEye,attachmentsIncluded,canHaveCosmetic,rifleSkill,marisaHuntingRifle\"/>";
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,mediumTopAttachments,largeTopAttachments,stock,bottomAttachments,attPerception,perkDeadEye,attachmentsIncluded,canHaveCosmetic,rifleSkill,marisaHuntingRifle,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"75,100\" tier=\"1,6\" tags=\"perkDeadEye\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,80,85,90,95,100\" tier=\"1,2,3,4,5,6\" tags=\"perkDeadEye\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunHuntingRifleSMarisaWeaponFlag_RANK\">\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunHuntingRifleSMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <passive_effect name=\"ReloadSpeedMultiplier\" operation=\"base_set\" value=\"1.5\" tags=\"perkDeadEye\"/>\n" +
