...
public class GunM60 {
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunMGT3M60";
    ...
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,magazine,drumMagazine,bottomAttachments,mediumTopAttachments,attFortitude,perkMachineGunner,perkBookAutoWeapons,attachmentsIncluded,canHaveCosmetic,machinegunSkill,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"450,600\" tier=\"1,6\" tags=\"perkMachineGunner,perkBookAutoWeapons\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,480,510,540,570,600\" tier=\"1,2,3,4,5,6\" tags=\"perkMachineGunner,perkBookAutoWeapons\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunM60SMarisaWeaponFlag_RANK\">\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunM60SMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <passive_effect name=\"RoundsPerMinute\" operation=\"base_set\" value=\"150\" tags=\"perkMachineGunner\"/>\n" +
