...
public class GunMagnum44 {
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunHandgunT2Magnum44";

    // 狂化Tag
    public static final String T1_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,shortRange,revolver,44enforcer,barrelAttachments,sideAttachments,smallTopAttachments,attAgility,perkGunslinger,attachmentsIncluded,canHaveCosmetic,handgunSkill,rangerDamage,enforcerReload,marisaMagnum44\"/>";
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,shortRange,revolver,44enforcer,barrelAttachments,sideAttachments,smallTopAttachments,attAgility,perkGunslinger,attachmentsIncluded,canHaveCosmetic,handgunSkill,rangerDamage,enforcerReload,marisaMagnum44,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"100,150\" tier=\"1,6\" tags=\"perkGunslinger\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,110,120,130,140,150\" tier=\"1,2,3,4,5,6\" tags=\"perkGunslinger\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunMagnum44SMarisaWeaponFlag_RANK\">\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunMagnum44SMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <passive_effect name=\"ReloadSpeedMultiplier\" operation=\"base_set\" value=\"2\" tags=\"perkGunslinger\"/>\n" +
