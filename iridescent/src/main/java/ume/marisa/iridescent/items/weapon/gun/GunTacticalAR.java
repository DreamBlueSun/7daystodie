...
public class GunTacticalAR {
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunMGT2TacticalAR";
    ...
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,barrelAttachments,sideAttachments,smallTopAttachments,mediumTopAttachments,stock,magazine,drumMagazine,firingMode,bottomAttachments,attFortitude,perkMachineGunner,perkBookAutoWeapons,canHaveCosmetic,attachmentsIncluded,machinegunSkill,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"350,500\" tier=\"1,6\" tags=\"perkMachineGunner,perkBookAutoWeapons\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,380,410,440,470,500\" tier=\"1,2,3,4,5,6\" tags=\"perkMachineGunner,perkBookAutoWeapons\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunTacticalARSMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <property name=\"Particles_muzzle_fire\" value=\"gunfire_MG_AR\"/>\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunTacticalARSMarisaWeaponFlag_RANK\">\n" +
