...
public class GunPumpShotgun {
    ...
    // 伤害
    public static final int RANK_ENTITY_DAMAGE_S0 = 5;
    public static final int[] RANK_ENTITY_DAMAGE_ARR = new int[]{5, 5, 5, 5, 7, 7, 7, 7, 9, 9, 9, 9, 0};
    ...
    // 模型
    public static final String RANK_MARISA_CUSTOMICON_1 = "gunShotgunT2PumpShotgun";

    // 狂化Tag
    public static final String T1_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,shotgun,shortRange,barrelAttachments,sideAttachments,smallTopAttachments,noScopes,stock,bottomAttachments,attStrength,perkBoomstick,modGunShotgunTubeExtenderMagazine,attachmentsIncluded,canHaveCosmetic,shotgunSkill\"/>";
    public static final String T3_TAG = "\n\t        <property name=\"Tags\" value=\"weapon,ranged,holdBreathAiming,reloadPenalty,gun,shotgun,shortRange,barrelAttachments,sideAttachments,smallTopAttachments,noScopes,stock,bottomAttachments,attStrength,perkBoomstick,modGunShotgunTubeExtenderMagazine,attachmentsIncluded,canHaveCosmetic,shotgunSkill,PerkT3Marisa\"/>";

    // 武器合成 星星
    public static final String STAR_DEGRADATION_A = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"150,200\" tier=\"1,6\" tags=\"perkBoomstick\"/>";
    public static final String STAR_DEGRADATION_B = "<passive_effect name=\"DegradationMax\" operation=\"base_set\" value=\"1,160,170,180,190,200\" tier=\"1,2,3,4,5,6\" tags=\"perkBoomstick\"/>";
    ...
    // item
    public static final String WEAPON_XML = "        <item name=\"GunPumpShotgunSMarisaWeaponFlag_RANK\">\n" +
            ...
            "                <property name=\"Sound_loop\" value=\"pump_shotgun_fire\"/>\n" +
            "                <property name=\"Sound_repeat\" value=\"\"/>\n" +
            "                <property name=\"Sound_end\" value=\"\"/>\n" +
            "                <property name=\"Sound_empty\" value=\"dryfire\"/>\n" +
            "                <property name=\"Sound_reload\" value=\"shotgun_reload\"/>\n" +
            "                <property name=\"AutoReload\" value=\"false\"/>\n" +
            "                <property name=\"Particles_muzzle_fire\" value=\"gunfire_SG_pump\"/>\n" +
            ...
            "\n" +
            "            <effect_group name=\"GunPumpShotgunSMarisaWeaponFlag_RANK\">\n" +
